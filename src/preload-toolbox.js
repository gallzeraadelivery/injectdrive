...
contextBridge.exposeInMainWorld('fakecam', {
  ...
  listVideoDevices: () => ipcRenderer.invoke('fakecam:listVideoDevices'),
  useObsCamera: (deviceId) => ipcRenderer.invoke('fakecam:useObsCamera', deviceId || null),
  ...
  cookiesExport: () => ipcRenderer.invoke('cookies:export'),
