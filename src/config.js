...
module.exports = {
  ...
  // false = permite preset desktop no perfil; true = força sempre celular
  FORCE_MOBILE_FINGERPRINT: false,
  ...
  SHORTCUTS: [
    ...
    { label: 'Suporte', url: 'https://help.uber.com/driving-and-delivering/article/unable-to-sign-in-or-go-online?nodeId=ee32a66e-c16e-4803-b03d-1444b829e791' },
    { label: 'Mudar nome da conta', url: 'https://account.uber.com/?_csid=jFZ6mbiD1tGzJtZz37oiKg&staterr=LpxweZfvuz_d8Aa-PVHEEHMymLUIDj6aR8OXlPha-Ok%3D&effect=' },
    { label: 'Fazer apelo na conta', url: 'https://t.uber.com/review-center' },
  ],
};